...
**Source verification:** 73 Python tests and the Electron/build Node suites pass; `git diff --check` is clean. Packaging and physical acceptance are the remaining steps.
