...
**Last updated:** 2026-08-05 — **0.1.1 built and packaged by Markey, incorporating the CoreAudio-hang and macOS-tray-icon fixes merged in `4a46c8e`.** Real DMG produced (`Push 2 Talk-0.1.1-arm64.dmg`, ad-hoc signed, `hdiutil verify` passed) but marked `UNVERIFIED` — the interactive visual smoke gate was deliberately skipped, disclosed reason below, not the fixes themselves being untested. See the 2026-08-05 session entry.
