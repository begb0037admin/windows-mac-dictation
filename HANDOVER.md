...
**Last updated:** 2026-08-05 — **0.1.2 corrects two packaged-first-launch regressions exposed immediately after installing 0.1.1:** the generic backend-exit crash before macOS Accessibility approval, and the 1024px PNG tray icon stretching across the menu bar. Corrected DMG built from clean commit `f828cb8`; package/signature/image integrity and the real Electron 18x18 tray preparation test pass. Human permission/hotkey/mic acceptance remains.
