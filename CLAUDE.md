...
- **Status:** MVP in progress — Steps 1–4 + live-caption rework confirmed working end-to-end on both platforms as of 2026-07-25. A further UI rework landed 2026-07-26 (editable review step, Pill/mini-bar mode, frameless/vibrancy window, corrected Mac hotkey default) — **not yet tested on either platform**, see `HANDOVER.md`. File transcription removed — it belongs to `meeting-transcriber`. Outstanding: retest both platforms against the new UI, Step 5 (run on login), a real Teams desktop/browser test, and packaging for colleagues (deferred — see `docs/BUILD_BRIEF.md` §12)
